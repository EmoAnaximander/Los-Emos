...
st.markdown("<h1 style='text-align: center;'>Singer Signup</h1>
<p style='text-align: center; font-size: 16px;'>One song per person. Once it's claimed, it disappears. We'll call your name when it's your turn to scream.</p>", unsafe_allow_html=True)
